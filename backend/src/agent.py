...
print("📚 SELLING: The Tech Stores Cloud & AI Courses")
...
DEFAULT_FAQ = [
    ...
    },
    {
        ...
        "answer": "Yes! The Tech Store releases weekly tutorials on YouTube for free. The paid courses offer deep-dives, code reviews, and certification."
    },
    {
...
class SDRAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions=f"""
            You are 'Sarah', a friendly and professional Sales Development Rep (SDR) for 'The Tech Store'.
            ...
            🚫 **RESTRICTIONS:**
            - If you don't know an answer, say "I'll check with Store Manager and email you." (Don't hallucinate prices).
            """,
